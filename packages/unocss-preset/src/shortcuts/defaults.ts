...
export const defaults: CustomShortcut[] = [
    ['o-flex-center', 'flex items-center justify-center'],
    ['o-flex-col-center', 'flex flex-col items-center justify-center'],
    ['o-transition', 'transition-all duration-150'],
    ['o-theme-text', 'text-[hsl(var(--ui-color-text))] dark:text-[hsl(var(--ui-color-text))]'],
