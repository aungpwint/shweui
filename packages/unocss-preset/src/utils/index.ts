 ...
 * @example
 * ```ts
 * resolveContextColorByKey([, theme, 500], theme, '--ui-color-context')
 *
 * => {
 *   '--ui-color-context': '0 100 50',
 * }
 *
 * resolveContextColorByKey([, , red], theme, '--ui-color-context')
 *
 * => {
 *   '--ui-color-context': '0 100 50',
 * }
 * ```
 */
export function resolveContextColorByKey(
